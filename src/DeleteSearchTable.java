 ...
 * @author w7
 */
public class DeleteSearchTable extends JPanel
{	
    /**
     * 
     ...
     */
    public DeleteSearchTable() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException 
	{ 
		...
		String query="select sno,firstname,lastname,category,city,mobile1,gmail from contact order by firstname";
		try
		{

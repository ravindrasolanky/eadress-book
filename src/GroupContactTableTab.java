 ...
 * @author w7
 */
public class GroupContactTableTab extends JPanel
{
     ...
     */
    public GroupContactTableTab(String group) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException 
	{ 
		...
		String query="select sno,firstname,lastname,city,mobile1,gmail from contact where category=? order by firstname";
		try
		{
